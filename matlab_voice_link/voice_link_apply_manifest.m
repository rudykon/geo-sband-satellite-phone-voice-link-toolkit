function cfg = voice_link_apply_manifest(cfg, manifest)
%VOICE_LINK_APPLY_MANIFEST Apply the Python-written co-simulation manifest.
...
if isfield(manifest, 'scenarios')
    ...
    for i = 1:n
        ...
        scenarioModelKey(i) = string(sc.scenario_model_key);
