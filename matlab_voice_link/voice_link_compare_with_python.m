function compareRows = voice_link_compare_with_python(cfg, voiceRows, outageRows, simRows)
%VOICE_LINK_COMPARE_WITH_PYTHON Compare MATLAB/Simulink outputs with Python CSVs.
...
if exist(pyVoicePath, "file")
    ...
    for i = 1:height(mainMatlab)
        pyIdx = strcmp(string(pyVoice.scenario), string(mainMatlab.scenario_model_key(i))) ...
