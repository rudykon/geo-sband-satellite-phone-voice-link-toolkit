function y = voice_link_simulink_scenario(u)
%VOICE_LINK_SIMULINK_SCENARIO Fixed-width output for the Simulink function block.
%
% Input:
%   u(1) scenario index
...
if evalin('base', "exist('voice_link_reference_cfg', 'var')")
    cfg = evalin('base', 'voice_link_reference_cfg');
else
