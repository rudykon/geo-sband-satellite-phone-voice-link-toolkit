function rows = voice_link_calibrate_phy_thresholds(cfg)
%VOICE_LINK_RUN_PHY_THRESHOLD_CALIBRATION Calibrate voice Eb/N0 thresholds.
%
...
for r = 1:numel(rates)
    ...
    thresholdDb = voice_link_interpolate_fer_threshold(berFerRows.ebn0_db(idx), berFerRows.fer(idx), targetFer);
...
function thresholdDb = voice_link_interpolate_fer_threshold(ebn0Db, fer, targetFer)
