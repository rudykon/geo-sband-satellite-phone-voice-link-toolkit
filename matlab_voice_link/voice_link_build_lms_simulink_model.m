function modelName = voice_link_build_lms_simulink_model(cfg)
%VOICE_LINK_BUILD_LMS_SIMULINK_MODEL Generate the LMS channel Simulink model.

modelName = "voice_link_lms_channel_timeseries_system";
...
try
    ...
    warning("voice_link:lmsSimulinkBlockFallback", ...
...
Simulink.Annotation(modelName, ...
    "voice-link LMS time-series channel: LOS/NLOS Markov state, lognormal shadowing, Rician/Rayleigh fading, frame-level FER, and voice availability.");
...
chart.Script = sprintf([ ...
    'function y = fcn(u)\n' ...
    '%%#codegen\n' ...
    'coder.extrinsic(''voice_link_simulink_lms_scenario'');\n' ...
    'y = zeros(9,1);\n' ...
    'y = voice_link_simulink_lms_scenario(u);\n' ...
    'end\n']);
end
