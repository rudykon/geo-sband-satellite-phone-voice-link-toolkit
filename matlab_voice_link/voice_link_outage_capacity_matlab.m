function rows = voice_link_outage_capacity_matlab(cfg)
%VOICE_LINK_OUTAGE_CAPACITY_MATLAB Exact and Monte Carlo outage-capacity check.
...
for k = 1:numel(sigmaScan)
    ...
    cap = log2(1.0 + gamma);
    cMc = voice_link_empirical_quantile(cap, eps0);
